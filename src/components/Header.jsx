      ...
      <nav className="w-full h-20 flex items-center justify-around mb-16 md:px-4 bg-gray-800 shadow-xl fixed z-20">
        ...
        <div className="">
          <ul className="hidden md:flex space-x-6 text-xl font-semibold text-gray-300 ">
            <li className="hover:text-gray-600 transition ease-out duration-500">
              <a href="#home">Home</a>
            </li>
            <li className="hover:text-gray-600 transition ease-out duration-500">
            ...
            {toggle ? (
              <li>
                <MdClose
                  ...
                  className="text-5xl text-gray-400 md:hidden block"
                />
              </li>
            ) : (
              <li>
        ...
        {/* responsive menu */}
        <ul
          className={`text-center text-4xl duration-500 md:hidden w-screen text-gray-800 font-bold fixed bg-slate-600 top-20 py-5 h-screen 
        ...
        >
          ...
          <li className=" p-4">
            <a onClick={() => settoggle(!toggle)} href="#education">
              Education
            </a>
          </li>
          <li className=" p-4">
            <a onClick={() => settoggle(!toggle)} href="#skills">
              Skills
            </a>
          </li>
          <li className=" p-4">
